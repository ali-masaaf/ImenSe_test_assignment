...
const ProfileMenuCard = () => {
    return ( 
        <ul className='container__profile-menu-card'>
            <li className='profile-menu-card__personal-information'>
                <span className='personal-information__group'>{groupName}</span>
                <span className='personal-information__email'>{email}</span>
            </li>
            <li className='profile-menu-card__account-managment'>
            ...
            <li className='profile-menu-card__logout'>
